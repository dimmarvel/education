...
int main()
{
	...
	ifstream infile("ITER.DAT");   // создать входной файловый объект
								   // (файл ITER.DAT должен уже существовать) итераторы istream
	istream_iterator<int> file_iter(infile);  // файл
	istream_iterator<int> end_of_stream;   // eos (конец потока) копировать данные из входного файла в iList
