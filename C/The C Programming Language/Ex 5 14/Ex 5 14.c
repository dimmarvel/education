...
#include <string.h>
#include <stdlib.h>
#include <C:/Users/dimma/Desktop/All_Tasks_Progects/C/The C Programming Language/Ex 5 14/WriteReadLines.c>
...
int main(int argc, char **argv)
{
	...
	if (argc > 2)
	{
		printf("ERROR: invalid parametrs/n");
		return 1;
	}
	...
	{
		printf("wrong parameters, to use default/n");
		n = reserve;
	}
