    ...
    for (int i = 0; i < size; i++)
    {
        ...
        if (command == "CHANGE_CAPITAL")
        {
            ...
            if (country_capital.find(country) != country_capital.end())
            {
                if (country_capital[country] == "" ||
                    country_capital[country] == new_capital) // if have NO capital or new capital == old capital
                {
                ...
                else // if HAVE capital but changed now
                {
                    ...
                    cout << "Country " << country << " has changed its capital from " << country_capital[country]
                         << " to " << new_capital << endl;
        ...
        else if (command == "RENAME")
        {
            ...
            if (key != country_capital.end()) // if exist
            {
                ...
                {
                    cout << "Country " << old_country_name << " with capital " << key->second << " has been renamed to "
