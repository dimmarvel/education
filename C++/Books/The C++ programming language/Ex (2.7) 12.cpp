...
struct day_name
{
    ...
    {"January", 31}, {"February", 28}, {"March", 30},     {"April", 31},   {"May", 30},      {"June", 31},
...
int main()
{
    ...
    string name_of_month[12] = {"January", "February", "March",     "April",   "May",      "June",
    ...
    for (int i = 0; i < 12; i++)
    {
        cout << day_name_arr[i].name << " - " << day_name_arr[i].day << endl;
    }
    return 0;
}
