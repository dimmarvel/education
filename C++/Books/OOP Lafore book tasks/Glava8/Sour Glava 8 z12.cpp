...
public:
    ...
    void putSterling() const { cout << "Result: J" << pounds << "." << shilling << "." << pens << endl; }
    long get_pounds() const { return pounds; }
    int get_shilling() const { return shilling; }
    int get_pens() const { return pens; }
};
...
public:
    ...
    long double get_number() const { return number; }
};
