...
public:
    ...
    void setSoftSkills(string _SoftSkills) { SoftSkills = _SoftSkills; }
    void setAnotherSkills(string _AnotherSkills) { AnotherSkills = _AnotherSkills; }
    void Out_Info()
    {
        cout << "Name: " << name << endl;
        cout << "Age: " << Age << endl;
...
{
public:
    AnketaBuilder() { _result = new Anketa(); }
    void configureName(string _name) { _result->setName(_name); }
    void configureAge(string _Age) { _result->setAge(_Age); }
    void configureText(string _Text) { _result->setText(_Text); }
    void configureSoftSkills(string _SoftSkills) { _result->setSoftSkills(_SoftSkills); }
    void configureAnotherSkills(string _AnotherSkills) { _result->setAnotherSkills(_AnotherSkills); }
};
...
int main()
{
    ...
    vector<string> info = {"Dima", "11.11.2000", "none", "C++,C,C#,", "Communication"};
